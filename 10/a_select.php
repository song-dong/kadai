...
if($status==false){
  ...
  while( $result = $stmt->fetch(PDO::FETCH_ASSOC)){
    ...
    $view .= '<td>'.'<button><a href="a_detail.php?id='.$result["id"].'">';
    $view .= 'Update';
    $view .= '</a></button>';
//    $view .= '<br>';
    $view .= '<button><a href="a_delete.php?id='.$result["id"].'">';
    $view .= 'Delete';
    $view .= '</a></button>'.'</td>';
    $view .= '</tr>';
  }
            ...
            <nav class="navbar navbar-default">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <button><a class="navbar-brand" href="a_index.php">Register more</a></button>
                    </div>
                </div>
            </nav>
